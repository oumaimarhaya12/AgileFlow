...
public class SprintController {
    ...
    public ResponseEntity<SprintDTO> createSprint(
        ...
        SprintDTO sprint = sprintService.createSprint(name, startDate, endDate, sprintBacklogId);
    ...
    public ResponseEntity<List<SprintDTO>> getSprintsBySprintBacklogId(@PathVariable Long sprintBacklogId) {
    ...
    public ResponseEntity<List<SprintDTO>> getActiveSprintsByDate(@RequestParam(required = false) LocalDate date) {
    ...
    public ResponseEntity<SprintDTO> assignSprintToSprintBacklog(
    ...
    public ResponseEntity<SprintDTO> removeSprintFromSprintBacklog(@PathVariable Long sprintId) {
